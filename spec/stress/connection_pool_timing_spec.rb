...
describe 'Connection pool timing test' do
  ...
  context 'when there is no max idle time' do
    ...
    it 'does not error' do
      ...
      puts "[Connection Pool Timing] Duration with no max idle time: #{Utils.monotonic_time - start}"
    end
  end
  ...
  context 'when there is a low max idle time' do
    ...
    it 'does not error' do
      ...
      puts "[Connection Pool Timing] Duration with low max idle time: #{Utils.monotonic_time - start}"
    end
  end
  ...
  context 'when clear is called periodically' do
    ...
    it 'does not error' do
      ...
      puts "[Connection Pool Timing] Duration when clear is called periodically: #{Utils.monotonic_time - start}"
    end
  end
  ...
  context 'when primary is changed, then more operations are performed' do
    ...
    it 'does not error' do
      ...
      puts "[Connection Pool Timing] Duration before primary change: #{@primary_change_start - start}. "\
        "Duration after primary change: #{Utils.monotonic_time - @primary_change_end}"
    end
  end
end
