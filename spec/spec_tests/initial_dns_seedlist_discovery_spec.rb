...
INITIAL_DNS_SEEDLIST_DISCOVERY_TESTS = Dir.glob("#{CURRENT_PATH}/spec_tests/data/initial-dns-seedlist-discovery/**/*.yml").sort
...
describe 'DNS Seedlist Discovery' do
  ...
  INITIAL_DNS_SEEDLIST_DISCOVERY_TESTS.each do |test_path|
