...
describe Mongo::Cursor do
  ...
  describe '#each' do
    ...
    context 'when no options are provided to the view' do
      ...
      let(:view) do
        Mongo::Collection::View.new(authorized_client[TEST_COLL])
      end
      ...
      context 'when a limit is provided' do
        ...
        context 'when no batch size is provided' do
          ...
          context 'when the limit is positive' do
            ...
            let(:view) do
              Mongo::Collection::View.new(authorized_client[TEST_COLL], {}, :limit => 2)
            end
          ...
          context 'when the limit is zero' do
            ...
            let(:view) do
              Mongo::Collection::View.new(authorized_client[TEST_COLL], {}, :limit => 0)
            end
