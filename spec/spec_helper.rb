...
CRUD_TESTS_2_4 = Dir.glob("#{CURRENT_PATH}/support/crud_tests/server_2_4/**/*.yml")
CRUD_TESTS_2_6 = Dir.glob("#{CURRENT_PATH}/support/crud_tests/server_2_6/**/*.yml")
CRUD_TESTS_3_0 = Dir.glob("#{CURRENT_PATH}/support/crud_tests/server_3_0/**/*.yml")
CRUD_TESTS_3_2 = Dir.glob("#{CURRENT_PATH}/support/crud_tests/server_3_2/**/*.yml")
CRUD_TESTS_3_4 = Dir.glob("#{CURRENT_PATH}/support/crud_tests/server_3_4/**/*.yml")
