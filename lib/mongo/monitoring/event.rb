...
require 'mongo/monitoring/event/connection_checked_in'
require 'mongo/monitoring/event/connection_checked_out'
require 'mongo/monitoring/event/connection_checkout_failed'
require 'mongo/monitoring/event/connection_checkout_started'
require 'mongo/monitoring/event/connection_closed'
require 'mongo/monitoring/event/connection_created'
require 'mongo/monitoring/event/connection_ready'
require 'mongo/monitoring/event/pool_cleared'
require 'mongo/monitoring/event/pool_closed'
require 'mongo/monitoring/event/pool_created'
